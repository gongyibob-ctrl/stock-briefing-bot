...
def fetch_market_tables() -> dict:
    ...
    tables = {
        ...
        # hsgt_summary 已删除：北向数据 2024-08-19 起停发
...
def render_markdown(market, deep, screening) -> str:
    ...
    if market:
        out.append("## 🌐 全市场态势\n")
        # 北向资金 section 已删除：港交所 + 证监会 2024-08-19 起停发北向当日数据。
